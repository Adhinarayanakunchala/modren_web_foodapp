...
export function usePagination({
  ...
  return {
    ...
    goToPrevious: () => onPageChange(currentPage - 1),
    goToNext: () => onPageChange(currentPage + 1),
    goToPage: (page: number) => onPageChange(page),
  }
}

// Advanced pagination component
interface AdvancedPaginationProps extends UsePaginationProps {
  className?: string
}
      ...
      <PaginationContent>
        <PaginationItem>
          <PaginationPrevious
            ...
            className={cn(!pagination.canGoToPrevious && "opacity-50 cursor-not-allowed")}
        ...
        <PaginationItem>
          <PaginationNext
            ...
            className={cn(!pagination.canGoToNext && "opacity-50 cursor-not-allowed")}
